...
class DashboardPage
  ...
  NAV_LINK_LETS_SEE = "button[data-test-nav-link='letsSee']"
  NAV_LINK_INSIGHTS = "button[data-test-nav-link='insights']"
  NAV_LINK_LEGACY = "button[data-test-nav-link='legacy']"
  NAV_LINK_WHAT_IF = "button[data-test-nav-link='whatIf']"
  NAV_LINK_REPORTS = "button[data-test-nav-link='reports']"
  CHART_TYPE = "button[data-test-type='true']"
  CHART_DETAIL = "button[data-test-detailed='true']"
  CHART_DRILLDOWN = "button[data-test-drilldown='true']"
  ACCORDION_SECTION = 'div#accordion'
  NET_WORTH = "div[data-test-net-total='true']"
  PEOPLE_LINK = "a[data-test-accordion-header='people']"
  PLAN_SETTINGS_LINK = "a[data-test-accordion-header='settings']"
  ALLOCATION_CHART = "div[data-highlights-chart]"
  ...
  NEW_FORM = "form[data-test-expense-basic-form='true']"
  ...
  NEW_FORM_OWNER_BTN = "button[data-test-owner='true']"
  ...
  NEW_FORM_LINKED_EMP = 'div[data-test-employmentId]'
  ...
  EDIT_BASICS_BTN = "button[data-test-edit-tab='Basics']"
  ...
  def validate_page_elements
    elements = [CLIENT_ACTIONS_BTN, NAV_LINK_SELECTED, NAV_LINK_DASHBOARD,
      ...
      NET_WORTH, PEOPLE_LINK, PLAN_SETTINGS_LINK, ALLOCATION_CHART, ADD_BTN]
  ...
  def validate_add_preretirement_goal_elements
    elements = [NEW_FORM, NEW_FORM_TITLE, NEW_FORM_OWNER_BTN, NEW_FORM_NAME, 
  ...
  def validate_add_term_life_elements
    elements = [NEW_FORM, NEW_FORM_TITLE, NEW_FORM_OWNER_BTN, NEW_FORM_NAME, 
      NEW_FORM_TYPE, NEW_FORM_LINKED_EMP, NEW_FORM_INSURED_DIFF,
